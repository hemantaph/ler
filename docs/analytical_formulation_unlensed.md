...
| :--- | :--- | :--- | :--- | :--- |
| $z_s$ | - | $P(z_s)$ with $R_{\rm U}(z_s)$ <br>given by SFR <br>Madau-Dickinson <br>functional form | [0, 10] | Source redshift <br>(B=2.57, C=3.36, D=5.83) <br>(Ng et al. 2021) |
| $m_{1,2}$ | $M_\odot$ | PowerLaw<br>+Peak | [4.98, 112.5] | Component masses <br>($\alpha$=3.78, $\mu_g$=32.27, $\sigma_g$=3.88, <br>$\lambda_p$=0.03, $\delta_m$=4.8, $\beta$=0.81) <br>(Abbott et al. 2023, GWTC-3) |
...
| $t_c$ | s | Uniform | [0, 1 year] | Coalescence time within a year |
