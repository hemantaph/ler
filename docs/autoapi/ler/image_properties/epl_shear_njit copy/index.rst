:py:mod:`ler.image_properties.epl_shear_njit copy`
==================================================

.. py:module:: ler.image_properties.epl_shear_njit copy
...
.. autoapisummary::
   ...
   ler.image_properties.epl_shear_njit copy.pol_to_ell
   ler.image_properties.epl_shear_njit copy.omega_scalar
   ler.image_properties.epl_shear_njit copy.lensing_diagnostics_scalar
   ler.image_properties.epl_shear_njit copy.fermat_potential_scalar
   ler.image_properties.epl_shear_njit copy.image_position_analytical_njit
   ler.image_properties.epl_shear_njit copy.create_epl_shear_solver
...
.. autoapisummary::
   ...
   ler.image_properties.epl_shear_njit copy.EPS
   ler.image_properties.epl_shear_njit copy.MAX_ROOTS
   ler.image_properties.epl_shear_njit copy.MAX_IMGS
   ler.image_properties.epl_shear_njit copy.C_LIGHT
