...
.. glossary::
   ...
   Gravitational waves
      ...
      .. raw:: html
         ...
         <img src="_static/gw.gif" width="90%" alt="Animation of GW propagation">
   ...
   Lensing of gravitational waves
      ...
      .. raw:: html
         ...
         <div style="text-align:center;">
         <img src="_static/Light_Bending.gif" width="90%" alt="Animation of light bending">
          <div style="text-align:left; max-width:90%; margin: 0 auto;">
            <p style="font-size: 0.9em; font-family: Arial, sans-serif; line-height: 1.5em;">
   ...
   Rate calculation and statistics
      ...
      .. raw:: html
         ...
         <div style="text-align:center;">
         <img src="_static/Merger_rate_density_and_PDF_of_redshift.png" width="90%" alt="BBH Merger rate density">
          <div style="text-align:left; max-width:90%; margin: 0 auto;">
            <p style="font-size: 0.9em; font-family: Arial, sans-serif; line-height: 1.5em;">
