...
def main():
    ...
    ler = LeR(
        ...
        ),  # to store only detectable lensed events
        ...
        lens_param_samplers_params={
            ...
            "external_shear": {"scale": 0.05},
            "density_profile_slope": {"mean": 2.0, "std": 0.2},
    ...
    # calculate rates.
    # compare the rates.
    rate_ratio, unlensed_param_detectable, lensed_param_detectable = (
        ler.rate_comparison_with_rate_calculation(
            ...
            num_img=[
                1,
                1,
            ],  # number of images corresponding to the snr_threshold_lensed
