...
from .jit_functions import phi_cut_SIE, axis_ratio_rayleigh, phi_cut_epl_shear, bounded_normal_sample
from ..utils import inverse_transform_sampler, cubic_spline_interpolator, append_json
...
def optical_depth_epl1_mp(params):
    """
...
def test(params):
    ...
    tau =quad(tau_integrand, 0, params[0], args=(params[0]))[0]
    
    append_json('optical_depth.json', dict(zs=[zs,], tau=[tau,],), replace=False)
