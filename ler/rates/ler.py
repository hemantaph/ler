...
class LeR(LensGalaxyParameterDistribution):
    ...
    **kwargs : ``dict``
    ...
    def unlensed_cbc_statistics(
        ...
        -------
        unlensed_param : ``dict``
            Sampled unlensed GW source parameters.
    ...
    def unlensed_rate(
        ...
        unlensed_param : ``dict``
            Detectable unlensed GW source parameters.
    ...
    def lensed_cbc_statistics(
        ...
        -------
        lensed_param : ``dict``
            Sampled lensed GW source parameters.
    ...
    def lensed_rate(
        ...
        lensed_param : ``dict``
            Detectable lensed GW source parameters.
