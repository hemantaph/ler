...
$ler$ has established a measurable impact within the gravitational wave community through its integration into research workflows and its growing user base. The package has recorded over 3000 downloads from PyPI [@lerpypi] and supports a diverse community ranging from students to faculty members at multiple institutions. Development is driven by contributions from researchers across various organizations and has undergone peer review within the LIGO-Virgo-KAGRA Scientific Collaboration [@lerlvkpnpreview]. Active community engagement is maintained through bug reporting and feature requests on version control platforms (github issue tracker) and collaboration communication channels (ligo mattermost).

The software has facilitated several scientific publications related to gravitational wave lensing statistics. It has been used to analyze the distribution of time delays and magnification ratios for the validation of lensing candidates [@Janquart:2023] and to forecast the detection of sub-threshold lensed events with future observatories [@Ng:2025]. Additional research applications include the generation of lensed event statistics and calculation of odds ratio [@Hannuksela:2026], and the forecasting of electromagnetic counterparts for strongly lensed gamma-ray bursts [@More:2025]. These implementations demonstrate that the tool provides a reliable and ready framework for high-level population studies and astrophysical forecasting.
