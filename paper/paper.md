...
`ler` has established a measurable impact within the gravitational-wave community through its integration into research workflows and its growing user base. The package supports a diverse community ranging from students to faculty members at multiple institutions, with development driven by researchers across various organizations and peer-reviewed within the LVK Scientific Collaboration [@lerlvkpnpreview:2024]. Active community engagement is maintained through bug reports and feature requests on the GitHub issue tracker and through collaboration communication channels such as LIGO Mattermost.
