---
title: '$\mathcal{ler}$ : LVK (LIGO-Virgo-KAGRA collaboration) Event (compact-binary mergers) Rate calculator and simulator'
tags:
  - Python
  - astrophysics
  - statistics
...
- Generation of image properties:
    ...
    * Sampled lens properties and source position is fed in *Lenstronomy* to generate properties of the images. This is the slowest part of the entire simulation, which $\mathcal{ler}$ tackles through parallelization with multiprocessing.
